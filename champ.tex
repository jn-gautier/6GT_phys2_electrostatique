...
\begin{figure}[!ht]
    \centering
    \centering
    \includegraphics[width=.6\linewidth]{champ_temperature.jpg}
    \caption{Représentation d'un champ de température}
    \label{champ_temperature}
\end{figure}
\begin{figure}[!ht]
    \centering
    \includegraphics[width=.6\linewidth]{carte_meteo.png}
...
\begin{figure}[!ht]
    ...
    \begin{minipage}[b]{.47\linewidth}
        \centering
        \resizebox{.8\linewidth}{!}{\input{./tikz/vecteurs_champ_pos.tikz}}
...
\begin{figure}[!ht]
    \centering
    \resizebox{.6\linewidth}{!}{\input{./tikz/intensite_vecteur_champ.tikz}}
...
\begin{figure}[!ht]
    \centering
    \resizebox{.6\linewidth}{!}{\input{./tikz/lignes_champ.tikz}}
...
\begin{figure}[!ht]
    ...
    \begin{minipage}[b]{.49\linewidth}
        \centering
        \tikzsetnextfilename{champ_pos_neg}
        \resizebox{\linewidth}{!}{\input{./tikz/champ_pos_neg.tikz}}
        \caption{Lignes de champ (en bleu) entre deux charges de signes opposés.}
        \label{champ_pos_neg}
    \end{minipage}
    \begin{minipage}[b]{.49\linewidth}
        \centering
        \tikzsetnextfilename{champ_pos_pos}
        \resizebox{\linewidth}{!}{\input{./tikz/champ_pos_pos.tikz}}
...
\begin{figure}[!ht]
    \centering
    \tikzsetnextfilename{champ_six_charges}
    \resizebox{.7\linewidth}{!}{\input{./tikz/six_charges.tikz}}
